<div class="hidden lg:flex min-h-screen">
    <aside class="w-64 bg-blue-900 text-white flex flex-col fixed h-screen">
        ...
        <nav class="flex-1 mt-6 px-5">
            <ul class="space-y-4">
                <li>
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center px-3 py-2 rounded-lg bg-blue-900
                    {{ request()->routeIs('admin.dashboard') ? 'bg-blue-500' : 'hover:bg-blue-600' }}">
                ...
                <li>
                    <a href="{{ route('admin.jalur_pendaftaran.index') }}" class="flex items-center px-3 py-2 rounded-lg hover:bg-blue-600 bg-blue-900
                    {{ request()->routeIs('admin.jalur_pendaftaran.index') || request()->routeIs('admin.jalur_pendaftaran.show') || request()->routeIs('admin.sertifikat_murid') ? 'bg-blue-500' : 'hover:bg-blue-600' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-6">
                ...
                <li>
                    <a href="{{ route('test_field') }}" class="flex items-center px-3 py-2 rounded-lg hover:bg-blue-600 bg-blue-900
                    {{ request()->routeIs('test_field') || request()->routeIs('test_field') ? 'bg-blue-500' : 'hover:bg-blue-600' }}">
